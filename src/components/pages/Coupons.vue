				...
				<div class="modal-content border-0">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="text" v-model="tempCoupon.code" class="form-control" id="id"
							placeholder="請輸入優惠碼">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" v-model="tempCoupon.percent" class="form-control" id="percent"
...
export default {
	...
	methods: {
		...
		delCoupon() {	
			const api = `${process.env.APIPATH}/api/${process.env.CUSTOMPATH}/admin/coupon/${this.delItem.id}`;
			const vm = this;
			this.$http.delete(api,vm.delItem).then((response) => {
				// console.log(response.data);				
